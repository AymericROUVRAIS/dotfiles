...
mkdir -p ~/.config/alacritty/colorschemes
curl -LO --output-dir ~/.config/alacritty/colorschemes https://github.com/catppuccin/alacritty/raw/main/catppuccin-mocha.toml
